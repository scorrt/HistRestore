...
Comparison: Full/Qwen-prior HistRestore vs the strongest fixed blend (`docres_classical040_blend_0.85`) on the same 113 source-page held-out pages.

| Metric | Mean diff | Bootstrap 95% CI | paired t p | Wilcoxon p | Cohen dz | Rank-biserial | Win rate |
|---|---:|---:|---:|---:|---:|---:|---:|
| PSNR | 0.430353 | [-0.000517, 0.898369] | 0.0642085 | 0.048608 | 0.1758 | 0.2283 | 0.4690 |
